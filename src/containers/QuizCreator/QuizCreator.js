...
import {finishCreateQuiz, createQuizQuestion} from '../../store/actions/creaate'


function createOptionContro(number) {
...
function createFormControls() {
	return {
		question: createControl({
			...
			errorMessage: 'Вопрос не может быть пустим'
		},{required: true}),
...
class QuizCreator extends React.Component {
	...
	state = {
		...
		quizTitle:  createControl({
			...
			errorMessage: 'Название теста не может быть пустим'
		},{required: true}),
	}
			...
			<div className={classes.QuizCreator}>
				...
				<Input 
					...
					onChange={event => {
						...
						title.touched = true
						title.valid = Validate(title.value, title.validation)
						this.setState({
							quizTitle: title
						})
					}}
